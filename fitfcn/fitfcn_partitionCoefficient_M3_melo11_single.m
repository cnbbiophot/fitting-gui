function fVes=fitfcn_partitionCoefficient_M3_melo11_single(param, tdata)
...
xm=(Kp.*LAccessible)./(W+Kp.*LAccessible); % Mole fraction of labeled-proteins bound to vesicles
