function PCHnorm=fitfcn_PCHseveral4Species_single (param, tdata)
...
PCHnorm = simulationPCH_severalSpecies(omega0,z0,[epsilon1 epsilon2 epsilon3 epsilon4],[conc1 conc2 conc3 conc4], maxK);
