function PCHnorm=fitfcn_PCHseveral2Species_global (param, indParam, x)
...
z0=param(indParam(:,7));
omega0=param(indParam(:,8));

PCHnorm = simulationPCH_severalSpecies_global(omega0,z0,[epsilon1 epsilon2 epsilon3],[conc1 conc2 conc3], maxK, number_sets, k);
