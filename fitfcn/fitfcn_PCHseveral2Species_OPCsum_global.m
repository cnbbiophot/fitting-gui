function PCHnorm=fitfcn_PCHseveral2Species_OPCsum_global (param, indParam, x)
...
PCHnorm = simulationPCH_severalSpecies_global([epsilon1 epsilon2],[averageN1 averageN2], ...
    [F1 F2], [Q1 Q2], length_K, number_sets);
