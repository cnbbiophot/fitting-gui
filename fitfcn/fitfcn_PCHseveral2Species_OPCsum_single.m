function PCHnorm=fitfcn_PCHseveral2Species_OPCsum_single (param, tdata)
...
PCHnorm = simulationPCH_severalSpecies([epsilon1 epsilon2],[averageN1 averageN2],...
    [F1 F2], [Q1 Q2], length_K);
